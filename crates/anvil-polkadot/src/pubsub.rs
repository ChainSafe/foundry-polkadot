...
//                     if logs.is_empty() {
//                         // this ensures we poll the receiver until it is pending, in which case
// the                         // underlying `UnboundedReceiver` will register the new waker, see
...
// pub fn filter_logs(block: Block, receipts: Vec<TypedReceipt>, filter: &FilteredParams) ->
// Vec<Log> {     /// Determines whether to add this log
//     fn add_log(
//         block_hash: B256,
